...
<div class="row">
    <div class="col-12">
        ...
        <form action="<?= HOME ?>/estoque/salvarEnvio" class="row" method="post">
            ...
            <div class="form-group col">
                ...
                <select class="form-control" name="id_unidade_origem" required>
                    <option value="">Selecione</option>
            ...
            <div class="form-group col">
                ...
                <select class="form-control" name="id_unidade_destino" required>
                    <option value="">Selecione</option>
                    <?php foreach ($this->unidades as $u) : ?>
                        <option value="<?= $u['id'] ?>"><?= ucfirst(strtolower($u['nome'])) ?></option>
                    <?php endforeach ?>
            ...
            <div class="form-group col">
                ...
                <input type="number" class="form-control" required name="qtd_envio">
            </div>
